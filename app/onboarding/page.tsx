...
export default function OnboardingPage() {
  ...
  return <AppShell><main className="ops-onboarding-page">
    <header className="ops-onboarding-header">
      <div><small>DELIVERY WORKSPACE</small><h1>Onboarding</h1><p>Focus on active client delivery: unfinished work, blockers, and the next accountable action.</p></div>
      <Link href="/?newAccount=1" className="ops-header-action">Add account</Link>
    </header>
    <div className="ops-onboarding-content">
      <section className="onboarding-metrics" aria-label="Onboarding summary">
