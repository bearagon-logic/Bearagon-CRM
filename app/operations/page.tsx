...
export default function Operations() {
  ...
  return <AppShell><main className="lane-page"><header className="lane-header"><div><small>ONGOING SERVICE</small><h1>Operations</h1><p>What each company ordered, its installations, and the latest available Console reports.</p></div><Link className="ops-header-action" href="/automations">Automation inventory</Link></header><div className="lane-body">
