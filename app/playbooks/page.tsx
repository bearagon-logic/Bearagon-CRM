...
export default function Playbooks() {
  return <AppShell><main className="lane-page"><header className="lane-header"><div><small>EMPLOYEE FIELD GUIDE</small><h1>Playbooks</h1><p>Scope thoughtfully. Build in the harness. Verify with evidence.</p></div></header><div className="lane-body">
    ...
    <section className="lane-panel lane-guide"><h2>Guided Email assistance setup</h2><p>Google Workspace and Microsoft 365 routes now include saved configuration, step-by-step instructions, work notes and evidence. Open a company’s Build & test (or internal Automation work), then choose Start guided email setup beside Email assistance.</p><p>This pilot guides a human builder; it does not connect accounts, send messages or deploy a workflow. Other services retain their reference guides below.</p><Link href="/companies">Choose a company →</Link></section>
