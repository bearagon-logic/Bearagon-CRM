...
export type DeliveryRecord = { organizationKind?:string; id: string; accountId: string; accountName: string; status: string; stage: string; owner: string; nextStep: string; targetDate: string; blocked: number; open: number };
