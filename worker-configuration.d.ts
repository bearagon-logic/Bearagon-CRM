/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config wrangler.local.jsonc --env-interface CloudflareEnv` (hash: 7e88fa8b7f6a165ac70d809abc43cb3a)
